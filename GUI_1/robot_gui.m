...
%theta=0,d,a,alpha,
L(1) = Link([0,d_2,a_2,anpha_2,0]);
L(2) = Link([0,d_3,a_3,anpha_3,0]);
L(3) = Link([0,d_4,a_4,anpha_4,0]);
L(4) = Link([0,d_5,a_5,anpha_5,0]);

Robot=SerialLink(L);
Robot.name = '4DOF Robot';
cla
Robot.plot([ 0 0  -pi/2  pi/2  ]); %hien thi voi goc theta tuong ung
...
qz=[ Th_1 Th_2 Th_3 Th_4 ]; %cac goc theta
T=Robot.fkine(qz)  
PA=T*PEE;
x=PA(1,1);
y=PA(2,1);
...
a_cal=2*a3*k1;
b_cal=2*a3*k2;
d_cal=k1*k1+k2*k2+a3*a3-a4*a4;
if (a_cal*a_cal + b_cal*b_cal - d_cal*d_cal>=0)
...
handles.edit30.String = 'NaN';
handles.edit31.String = 'NaN'
handles.edit32.String = 'NaN'
handles.edit33.String = 'NaN'

handles.edit34.String = 'NaN'
handles.edit35.String = 'NaN'
handles.edit36.String = 'NaN'
handles.edit37.String = 'NaN'
end
...
Th_3 = str2double(handles.theta_3.String)*pi/180;
Th_4 = str2double(handles.theta_4.String)*pi/180;
setappdata(0,'a1',Th_1);
setappdata(0,'a2',Th_2);
setappdata(0,'a3',Th_3);
setappdata(0,'a4',Th_4);
time=str2double(handles.e_time.String);
%mo phong su dung toolbox
d_1 = 0;d_2 = 4.2;d_3 = 0;d_4 = 0;d_5 = 0;
a_1= 0;a_2=0.9;a_3=7.7;a_4=9.7;a_5=13.3;
